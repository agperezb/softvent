...
@section('content')
    <div class="controls-send">
        <button class="button-soft button-soft-secondary"
                onclick="window.location.replace('commerces/{{'register'}}')">
            <span>Registrar</span>
        ...
        @foreach($users as $user)
            <tr>
                <td class="controls-table">
                    <button onclick="window.location.replace('commerces/{{$user->id}}')"
                            class="button-soft button-soft-primary" data-toggle="tooltip"
                            data-placement="left"
                            title="Editar"><i class="fa fa-edit"></i>
                    </button>
                    <button onclick="window.location.replace('commerces/status/{{$user->id}}')"
...
@section('navigation')
    <div class="navigation">
        <a class="link-navigation" id="commerces" href="{{route('commerces')}}">Comercios</a>
        <a class="link-navigation" id="cashier" href="{{route('commerces')}}">Cajeros</a>
    </div>
@stop
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="modal-title" id="exampleModalLabel"><i class="fa fa-map-signs"></i>@if(session('id_to_update')) Editar @else Registrar @endif comercio</span>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="fa fa-times"></i>
                    </button>
                </div>
                <form id="register_form" action="@if(session('id_to_update')){{route('commerces_update',session('id_to_update'))}}@else{{route('commerces')}}@endif" method="POST" autocomplete="off" enctype="multipart/form-data">
